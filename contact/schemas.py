...
def check_email_length(value: str) -> str:
    """
...
def check_message_length(value: str) -> str:
    """
...
class ContactBase(BaseModel):
    ...
    _check_email_length = validator("email", allow_reuse=True)(check_email_length)
    
    # Custom validation for message field
    _check_message = validator("message", allow_reuse=True)(confirm_field)
    _check_message_length = validator("message", allow_reuse=True)(check_message_length)
